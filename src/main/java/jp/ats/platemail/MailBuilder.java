...
public class MailBuilder {
	...
	private final Optional<String> generatedMessageId;
	...
	/**
	 * DB接続を使用してMessage-IDを発行するインスタンスを生成
	 * @return MailBuilder
	 */
	public static MailBuilder getInstance() {
		String generatedMessageId = MessageIdGenerator.getInstance().generate();
	 ...
	 * @return MailBuilder
	 */
	public static MailBuilder getInstanceWithDefaultMessageId() {
		return new MailBuilder(new MimeMessage(Session.getInstance(System.getProperties(), null)), null);
	}

	public MailBuilder(MimeMessage message, String generatedMessageId) {
		this.message = message;
		this.generatedMessageId = Optional.ofNullable(generatedMessageId);
	}
	...
	public Optional<String> getGeneratedMessageId() {
